...
size_t loadTriangleMesh(
	...
	/*GLfloat vertices[] = {
		//triangle 0
		1.0f, 0.0f, 0.0f, //p0 vertex0
		0.0f, 1.0f, 0.0f, //n0 
		
		0.0f, 1.0f, 0.0f, //p1 vertex1
		0.0f, 1.0f, 0.0f, //n0
		
		0.0f, 1.0f, 0.0f, //p2 vertex2
		0.0f, 1.0f, 0.0f, //n0
		
		//triangle 1
		0.0f, 0.0f, 1.0f, //v0 vertex0
		0.0f, 1.0f, 0.0f, //n0
		
		1.0f, 0.0f, 0.0f, //v3 vertex3
		0.0f, 1.0f, 0.0f, //n0
		
		0.0f, 0.0f, 1.0f, //v2 vertex2
		0.0f, 1.0f, 0.0f, //n0
